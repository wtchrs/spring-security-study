...
public class AuthorizationServerConfig {
    ...
    /**
     * Add an "127.0.0.1 auth-server" entry in your /etc/hosts. It allows you to run the authorization server and the
     * client on your local machine, and avoid problems with session cookie overwrites between the two servers.
     */
    @Bean
